...
> 47  |     if (!code) throw new Error('Coupon code did not load after 30s');
  ...
  53  |   await this.page.goto(`${process.env.BASE_URL}/coupon`);
  54  |   await this.page.waitForURL('**/coupon', { timeout: 15000 });
  55  |   await this.page.getByRole('cell', { name: /MH-[A-Z0-9]{6,7}/ }).first()
