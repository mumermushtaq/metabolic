...
- Name: e2e\tasks.spec.js >> Tasks >> dismisses results with override
- Location: tests\e2e\tasks.spec.js:53:3
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e62]:
      ...
      - generic [ref=e172]:
        - generic [ref=e173]:
          - paragraph [ref=e175]: Chat
          - button "delete" [ref=e176] [cursor=pointer]:
            - img [ref=e177]
        - generic [ref=e181]:
          - paragraph [ref=e182] [cursor=pointer]: Metabolic
          - paragraph [ref=e183] [cursor=pointer]: Zone
  - alert [ref=e184]
```
