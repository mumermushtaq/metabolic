...
```
Error: locator.click: Error: strict mode violation: getByText('Physician') resolved to 2 elements:
    1) <div role="cell" minwidth="185px" data-column-id="3" id="cell-3-undefined" data-tag="allowRowEvents" class="sc-hKFxUR sc-eCAoTo sc-jSFhYz dxnPFW fqwYkn dKTboe rdt_TableCell">Physician</div> aka getByRole('cell', { name: 'Physician' })
    2) <label for="physician">…</label> aka getByRole('dialog').getByText('Physician')

Call log:
  - waiting for getByText('Physician')
...
- generic [ref=e1]:
  ...
  - dialog [ref=e371]:
    - generic [ref=e372]:
      - heading "Add User" [level=5] [ref=e374]
      - button "Close" [ref=e375] [cursor=pointer]
    - generic [ref=e377]:
      - generic [ref=e378]: Personal Info
      - generic [ref=e379]:
        - generic [ref=e380]:
          - generic [ref=e381]:
            - generic [ref=e382]: First Name
            - textbox "First Name" [ref=e383]: Test
          - generic [ref=e384]:
            - generic [ref=e385]: Last Name
            - textbox "Last Name" [ref=e386]: User347801
          - generic [ref=e387]:
            - generic [ref=e388]: Select Gender
            - generic [ref=e389]:
              - generic [ref=e391]:
                - text: Male
                - img [ref=e393]
              - generic [ref=e396]: Female
              - generic [ref=e398]: Other
          - generic [ref=e399]:
            - generic [ref=e400]: Phone
            - generic [ref=e402]:
              - generic [ref=e403]:
                - combobox "Phone number country" [ref=e404] [cursor=pointer]:
                  ...
                  - option "Zimbabwe"
                - img [ref=e406]
              - textbox "(XXX) XXX XXX" [active] [ref=e408]: (354) 123-1234
          - generic [ref=e409]: Professional Info
          - generic [ref=e410]:
            - generic [ref=e411]: Select Role
            - generic [ref=e412]:
              - generic [ref=e414]: Physician
              - generic [ref=e416]: Coach
              - generic [ref=e418]: Admin
          - generic [ref=e419]:
            - generic [ref=e420]: Job Title
            - generic [ref=e423]:
              - log [ref=e425]
              - generic [ref=e426] [cursor=pointer]:
                - generic [ref=e427]:
                  - generic [ref=e428]: Select Job Title
                  - combobox [ref=e430]
                - img [ref=e433]
        - generic [ref=e436]:
          - button "Add User" [ref=e437] [cursor=pointer]:
            - generic [ref=e438]: Add User
          - button "Cancel" [ref=e439] [cursor=pointer]:
            - generic [ref=e440]: Cancel
```
...
```ts
  ...
  40 | 
  41 |     if (gender) {
  42 |       await this.page.getByText(gender, { exact: true }).click();
  43 |     }
  44 | 
  45 |     if (phone) {
  46 |       await this.phoneInput.click();
  47 |       await this.phoneInput.fill(phone);
  48 |     }
  49 | 
  50 |     if (jobCategory) {
> 51 |       await this.page.getByText(jobCategory).click();
     |                                              ^ Error: locator.click: Error: strict mode violation: getByText('Physician') resolved to 2 elements:
  52 |     }
  53 | 
  54 |     if (jobTitle) {
  55 |       await this.jobTitleDropdown.nth(4).click();
  56 |       await this.page.getByRole('option', { name: jobTitle }).click();
  57 |     }
  58 | 
  59 |     await this.dialogAddUserBtn.click();
  60 |   }
  61 | 
  62 |   // ── Search for a team member ───────────────────────────────────
  63 |   async searchUser(query) {
  64 |     await this.searchInput.click();
  65 |     await this.searchInput.fill(query);
  66 |     await this.page.waitForTimeout(500);
  67 |   }
  68 | 
  69 |   // ── Clear active filter ─────────────────────────────────────────
  70 |   async clearFilter() {
  71 |     await this.clearFilterBtn.click();
  72 |   }
  73 | 
  74 |   // ── Open row actions dropdown by row name and select an option ──
  75 |   async openRowMenuByName(rowName, optionText) {
  76 |     const row = this.page.getByRole('row', { name: new RegExp(rowName) });
  77 |     await row.locator('#dropdown-basic').click();
  78 |     await this.page.getByText(optionText, { exact: true }).click();
  79 |   }
  80 | 
  81 |   // ── Edit a user by name (search → open dropdown → Edit Info) ───
  82 |   async editUserByName(fullName, updates = {}) {
  83 |     await this.searchUser(fullName);
  84 |     await this.page.getByText(fullName, { exact: true }).click();
  85 | 
  86 |     // Open the row's dropdown menu via the cell dropdown selector
  87 |     const dropdownBtn = this.page.locator('[id^="row-"] [id^="cell-"] #dropdown-basic').first();
  88 |     await dropdownBtn.click();
  89 |     await this.editInfoOption.click();
  90 | 
  91 |     // Apply any field updates here if needed in the future
  92 |     await this.editUserBtn.click();
  93 |   }
  94 | }
  95 | 
  96 | module.exports = { TeamPage };
```