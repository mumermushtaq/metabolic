...
Call log:
  ...
  - waiting for getByRole('dialog')
    48 × locator resolved to <div role="dialog" tabindex="-1" aria-modal="true" class="DrawerLayout_sidebarCanvas__sQLWF offcanvas offcanvas-end show">…</div>
...
- dialog:
  ...
  - text: Last Name
  - textbox "Last Name": Test1781724729237
  - text: Date of Birth
  ...
  - textbox "(XXX) XXX XXX": "3393634343"
