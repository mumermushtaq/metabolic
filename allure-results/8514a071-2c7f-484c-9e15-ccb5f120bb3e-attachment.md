...
- Location: tests\e2e\consent-intake.spec.js:50:3
...
Call log:
  - waiting for getByRole('combobox', { name: 'Visit Type' })
    - locator resolved to <button disabled type="button" role="combobox" aria-expanded="false" id="visit-type-combobox" aria-controls="visit-type-popover" class="ConsentIntake_comboboxTrigger__cZayx">…</button>
            ...
            - generic [ref=e155]:
              - generic [ref=e158]:
                - generic [ref=e159]:
                  ...
                  - generic [ref=e166]:
                    - img [ref=e167]
                    - generic [ref=e170]: "Last Updated: 23 Jun 2026, 02:07 AM"
                - generic [ref=e171]:
                  - generic [ref=e172]:
