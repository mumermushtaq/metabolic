          ...
          - rowgroup [ref=e85]:
            - row "Name ▲ Phone Number ▲ Role ▲ Job Title ▲ Patients Assigned ▲ Recent Activity ▲ Status ▲" [ref=e86]:
              ...
              - columnheader "Status ▲" [ref=e112] [cursor=pointer]:
                ...
                - generic [ref=e114]: ▲
          - rowgroup [ref=e116]:
            - row "Kaleem Asad Kaleem Asad +46726405823 Admin Nurse 32 7th January 2026 at 3:05 PM ACTIVATED" [ref=e117]:
            ...
            - row "StaffUser Four4 StaffUser Four4 +46726409554 Admin Life Coach 1 22nd December 2025 at 2:07 PM ACTIVATED" [ref=e237]:
              ...
              - cell [ref=e255]:
                - button [ref=e258] [cursor=pointer]:
                  - img [ref=e259]
            - row "StaffUser Six6 StaffUser Six6 +46726405822 Admin Nurse Manager 0 INVITED" [ref=e261]:
              - cell "StaffUser Six6 StaffUser Six6" [ref=e262]:
                - generic [ref=e263]:
                  - img "StaffUser Six6" [ref=e265] [cursor=pointer]
                  - generic [ref=e267]: StaffUser Six6
              - cell "+46726405822" [ref=e268]:
                - generic [ref=e269]: "+46726405822"
              - cell "Admin" [ref=e270]
              - cell "Nurse Manager" [ref=e271]
              - cell "0" [ref=e272]
              - cell [ref=e273]
              ...
              - cell [ref=e279]:
                - button [ref=e282] [cursor=pointer]:
                  - img [ref=e283]
            - row "Test B Account Test B Account +923314271267 Admin Diabetologist 0 INVITED" [ref=e285]:
              - cell "Test B Account Test B Account" [ref=e286]:
                - generic [ref=e287]:
                  - img "Test B Account" [ref=e289] [cursor=pointer]
                  - generic [ref=e291]: Test B Account
              - cell "+923314271267" [ref=e292]:
                - generic [ref=e293]: "+923314271267"
              - cell "Admin" [ref=e294]
              ...
              - cell [ref=e303]:
                - button [ref=e306] [cursor=pointer]:
                  - img [ref=e307]
            - row "Test User1 Test User1 +13541231234 Physician Diabetologist 0 INVITED" [ref=e309]:
              - cell "Test User1 Test User1" [ref=e310]:
                - generic [ref=e311]:
                  - img "Test User1" [ref=e313] [cursor=pointer]
                  - generic [ref=e315]: Test User1
              - cell "+13541231234" [ref=e316]:
                - generic [ref=e317]: "+13541231234"
              ...
              - cell [ref=e327]:
                - button [ref=e330] [cursor=pointer]:
                  - img [ref=e331]
            - row "Test User783074 Test User783074 +15551234567 Physician Diabetologist 0 INVITED" [ref=e333]:
              - cell "Test User783074 Test User783074" [ref=e334]:
                - generic [ref=e335]:
                  - img "Test User783074" [ref=e337] [cursor=pointer]
                  - generic [ref=e339]: Test User783074
              - cell "+15551234567" [ref=e340]:
                - generic [ref=e341]: "+15551234567"
      ...
      - generic [ref=e391]:
        - generic [ref=e392]:
          ...
          - generic [ref=e396]:
            ...
            - textbox "Last Name" [ref=e398]: User258042
          - generic [ref=e399]:
...
```ts
  ...
  57  | 
  58  |     if (jobTitle) {
  59  |       await this.jobTitleDropdown.nth(4).click();
  60  |       await this.page.getByRole('option', { name: jobTitle }).click();
  61  |     }
  62  | 
  63  |     // Confirm the submit button is enabled before clicking — a disabled button
  64  |     // means required fields are still missing/invalid
  65  |     await this.dialogAddUserBtn.waitFor({ state: 'visible', timeout: 10000 });
  66  |     const isDisabled = await this.dialogAddUserBtn.isDisabled().catch(() => false);
  67  |     if (isDisabled) {
  68  |       throw new Error('Add User submit button is disabled — a required field is likely missing or invalid.');
  69  |     }
  70  | 
  71  |     await this.dialogAddUserBtn.click();
  72  | 
  73  |     // Wait for the dialog to close — if it doesn't, the submission likely failed
  74  |     try {
  75  |       await dialog.waitFor({ state: 'hidden', timeout: 15000 });
  76  |     } catch (e) {
  77  |       const errorMsg = await dialog.locator('[class*="error"], [class*="Error"], .invalid-feedback')
  78  |         .first().textContent({ timeout: 2000 }).catch(() => null);
> 79  |       throw new Error(
      |             ^ Error: Add User dialog did not close after submit. No visible error message found.
  80  |         `Add User dialog did not close after submit.` +
  81  |         (errorMsg ? ` Possible validation error: "${errorMsg.trim()}"` : ' No visible error message found.')
  82  |       );
  83  |     }
  84  |     await this.page.locator('.offcanvas-backdrop').waitFor({ state: 'hidden', timeout: 10000 }).catch(() => {});
  85  |   }
  86  | 
  87  |   // ── Search for a team member ───────────────────────────────────
  88  |   async searchUser(query) {
  89  |     await this.searchInput.click();
  90  |     await this.searchInput.fill(query);
  91  |     await this.page.waitForTimeout(500);
  92  |   }
  93  | 
  94  |   // ── Clear active filter ─────────────────────────────────────────
  95  |   async clearFilter() {
  96  |     await this.clearFilterBtn.click();
  97  |   }
  98  | 
  99  |   // ── Open row actions dropdown by row name and select an option ──
  100 |   async openRowMenuByName(rowName, optionText) {
  101 |     const row = this.page.getByRole('row', { name: new RegExp(rowName) });
  102 |     await row.locator('#dropdown-basic').click();
  103 |     await this.page.getByText(optionText, { exact: true }).click();
  104 |   }
  105 | 
  106 |   // ── Edit a user by their row name (matches Codegen-confirmed flow) ──
  107 |   // rowName: partial row text, e.g. 'Kaleem Asad Kaleem Asad +' (name appears twice + phone prefix)
  108 |   async editUserByRowName(rowName) {
  109 |     const row = this.page.getByRole('row', { name: new RegExp(rowName) });
  110 |     await row.locator('#dropdown-basic').click();
  111 |     await this.page.getByText('Edit Info', { exact: true }).click();
  112 |     await this.editUserBtn.click();
  113 |   }
  114 | }
  115 | 
  116 | module.exports = { TeamPage };
```