...
Call log:
  - waiting for locator('h1, h2').filter({ hasText: /patients \(\d+\)/i })
...
```ts
  ...
  15  | 
  16  |     // ── Search ───────────────────────────────────────────────
  17  |     this.searchInput      = page.getByRole('textbox', { name: /search/i });
  18  |     this.clearFilterBtn   = page.getByRole('button', { name: /clear filter/i });
  19  | 
  20  |     // ── Filter ───────────────────────────────────────────────
  21  |     this.filterBtn        = page.getByRole('button', { name: /filter/i });
  22  | 
  23  |     // ── Filter Modal ─────────────────────────────────────────
  ...
  47  |     this.addPatientBtn    = page.getByRole('button', { name: /^\+ add patient$/i });
  48  |     this.addPatientMRNBtn = page.getByRole('button', { name: /add patient \(mrn\)/i });
  49  | 
  50  |     // ── Status badges ─────────────────────────────────────────
