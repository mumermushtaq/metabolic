...
Locator: getByRole('columnheader', { name: /patient/i })
Expected: visible
Error: strict mode violation: getByRole('columnheader', { name: /patient/i }) resolved to 2 elements:
    1) <div tabindex="0" data-sort-id="1" data-column-id="1" role="columnheader" class="sc-crzogQ TysvY rdt_TableCol_Sortable">…</div> aka getByRole('columnheader', { name: 'Patient ▲' })
    2) <div tabindex="0" data-sort-id="9" data-column-id="9" role="columnheader" class="sc-crzogQ TysvY rdt_TableCol_Sortable">…</div> aka getByRole('columnheader', { name: 'Patient Program ▲' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('columnheader', { name: /patient/i })
...
> 38  |     await expect(page.getByRole('columnheader', { name: /patient/i })).toBeVisible();
      |                                                                        ^ Error: expect(locator).toBeVisible() failed
  39  |     await expect(page.getByRole('columnheader', { name: /diagnosis/i })).toBeVisible();
  40  |     await expect(page.getByRole('columnheader', { name: /tir/i })).toBeVisible();
  41  |     await expect(page.getByRole('columnheader', { name: /food log/i })).toBeVisible();
  42  |     await expect(page.getByRole('columnheader', { name: /weight/i })).toBeVisible();
  43  |     await expect(page.getByRole('columnheader', { name: /active chats/i })).toBeVisible();
  44  |     await expect(page.getByRole('columnheader', { name: /status/i })).toBeVisible();
  45  |     await expect(page.getByRole('columnheader', { name: /verification date/i })).toBeVisible();
  46  |     await expect(page.getByRole('columnheader', { name: /patient program/i })).toBeVisible();
  47  |   });
  48  | 
