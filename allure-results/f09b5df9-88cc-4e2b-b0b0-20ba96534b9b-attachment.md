...
- Name: e2e\consent-intake.spec.js >> Consent & Intake >> edits interpreter details
- Location: tests\e2e\consent-intake.spec.js:82:3
...
Call log:
  - waiting for getByRole('button', { name: 'Edit interpreter' })
